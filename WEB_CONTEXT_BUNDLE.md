...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-geo-008-the-inscribed-square-problem-a9a7af78-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GEO-008"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-geo-008-the-inscribed-square-problem-a9a7af78-v1",
      "problem_contract_sha256": "b76a2b271ce8119da03b54cd465e68456cbc1e6310bad6a295b1f228e08c5599",
      "problem_id": "problem:um-geo-008-the-inscribed-square-problem-a9a7af78",
      "route_id": "route:um-geo-008-the-inscribed-square-problem-a9a7af78-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-geo-008-the-inscribed-square-problem-a9a7af78-source-fidelity-01",
      "graph_id": "graph:um-geo-008-the-inscribed-square-problem-a9a7af78-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-geo-008-the-inscribed-square-problem-a9a7af78-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-geo-008-the-inscribed-square-problem-a9a7af78-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does every simple closed curve in the plane contain four points that form the vertices of a square?"
          },
          "statement_sha256": "0ac34ce94068d292d7fe9093c5104bbdd2b820f964d368e235e21530dcc5ede8"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-geo-008-the-inscribed-square-problem-a9a7af78-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-geo-008-the-inscribed-square-problem-a9a7af78-root",
      "route_id": "route:um-geo-008-the-inscribed-square-problem-a9a7af78-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-geo-008-d717f11ef40f",
        "url": "https://www.unsolvedmath.com/problems/GEO-008"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
